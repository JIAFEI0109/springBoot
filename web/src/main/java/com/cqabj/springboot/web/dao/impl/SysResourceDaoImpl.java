...
public class SysResourceDaoImpl extends BaseDao implements SysResourceDao {
    ...
    @Override
    public List<SysResources> getClientAllResources() {
        String sql = "SELECT * FROM sys_resources s WHERE resource_type =:resourceType";
        String[] keys = { "resourceType" };
        Object[] values = { IGlobalConstant.CLIENT_LOGIN };
        return sqlExecuteList(SysResources.class, sql, keys, values, null);
    }
}
